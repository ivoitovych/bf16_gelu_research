...
void run_regression_suite(const UlpCalculator& ulp_calc) {
    ...
    std::vector<std::pair<std::string, std::function<std::bfloat16_t(std::bfloat16_t)>>> implementations = {
        ...
        {"P1: DOPRI Deg4 Seg8", gelu_dopri_deg4_seg8},
        {"P2: DOPRI Deg4 Seg16", gelu_dopri_deg4_seg16},
        {"P3: DOPRI Deg5 Seg6", gelu_dopri_deg5_seg6},
        {"P4: DOPRI Deg5 Seg10", gelu_dopri_deg5_seg10},
        {"P5: DOPRI Deg5 Seg12", gelu_dopri_deg5_seg12},
        {"P6: DOPRI Deg5 Seg16", gelu_dopri_deg5_seg16},
    };
...
int main(int argc, char* argv[]) {
    ...
    if (do_analyze) {
        ...
        std::vector<std::pair<std::string, std::function<std::bfloat16_t(std::bfloat16_t)>>> implementations = {
            ...
            // Category P: DOPRI-inspired piecewise polynomial
            {"P1: DOPRI Deg4 Seg8", gelu_dopri_deg4_seg8},
            {"P2: DOPRI Deg4 Seg16", gelu_dopri_deg4_seg16},
            {"P3: DOPRI Deg5 Seg6", gelu_dopri_deg5_seg6},
            {"P4: DOPRI Deg5 Seg10", gelu_dopri_deg5_seg10},
